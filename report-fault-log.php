	        ...
	        <div class="st-content-inner">
				...
				<div class="container">
					<div class="content-wrapper">
                        ...
                        <a href="ajax-faults-log-search.php"><button type="submit" class="btn btn-warning"><span class="glyphicon glyphicon-search"></span> Search for logged faults</button></a>
                        <!--a href=""><button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-th-list"></span> View Reports</button></a-->
                        <a href="logged-faults-form.php"><button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span> Log a fault</button></a>
                        <a href="query-logged-faults.php"><button type="submit" class="btn btn-info"><span class="glyphicon glyphicon-search"></span> View all faults</button></a>
		...
		<script type="text/javascript">
                    Highcharts.chart('container', {
                        ...
                        series: [{
                            ...
                            name: 'Fault Log',
                            data: [
                                ['Grain Carriers South Africa', 45.0],
                                ['Swartland Logistics', 26.8],
                                {
                                    name: 'Atang Logistics',
                                    y: 12.8,
                                    sliced: true,
                                    selected: true
                                },
                                ['Wamatha Logistics', 8.5],
                                ['Tacet', 6.2],
                                ['Leon Van Vuuren Bulk Carriers', 0.7]
                            ]
                        }]
                    });
                </script>
