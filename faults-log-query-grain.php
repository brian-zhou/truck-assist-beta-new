            ...
            <div class="st-content-inner">
                ...
                <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <br>
                                    <h2>Faults logged for Grain Carriers </h2>
                                    <h4>
                                        ...
                                        <a href="logout.php"><button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-off"></span> Exit</button></a> 
...
include('include/connection.php');
    ...
    $sql = "SELECT * FROM logged_faults WHERE client_name = 'Grain Carriers South Africa' ORDER BY `id` DESC";
    //$sql = "SELECT * FROM logged_faults ORDER BY `log_resolved` DESC";
    //$count = "SELECT COUNT(*) FROM logged_faults";
    //echo $count;
    $result = mysqli_query($conn, $sql);
    
    //$result2 = mysqli_query("SELECT count(*) AS total FROM logged_faults");
    //$data = mysql_fetch_assoc($result2);
   //echo $data['total'];
    
    $result2 = mysql_query("SELECT count(*) FROM logged_faults;");
